...
export const COUNTRY_VIEWS: Record<string, { longitude: number; latitude: number; zoom: number }> = {
  ...
  CN: { longitude: 104.0, latitude:  35.0, zoom:  4 },
  JP: { longitude: 138.0, latitude:  36.0, zoom:  5 },
  TW: { longitude: 121.0, latitude:  23.5, zoom:  7 },
  HK: { longitude: 114.2, latitude:  22.3, zoom: 10 },
  SG: { longitude: 103.8, latitude:   1.4, zoom: 11 },
  US: { longitude: -98.5, latitude:  39.5, zoom:  4 },
  CA: { longitude: -96.0, latitude:  60.0, zoom:  3 },
  AE: { longitude:  54.0, latitude:  24.0, zoom:  7 },
  GB: { longitude:  -2.0, latitude:  54.0, zoom:  5 },
  AU: { longitude: 133.0, latitude: -27.0, zoom:  4 },
  TH: { longitude: 101.0, latitude:  15.0, zoom:  6 },
  PH: { longitude: 122.0, latitude:  12.0, zoom:  5 },
  MY: { longitude: 109.7, latitude:   4.2, zoom:  5 },
  MO: { longitude: 113.5, latitude:  22.2, zoom: 12 },
